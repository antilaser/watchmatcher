...
class SellOffer(UUIDPKMixin, TimestampMixin, Base):
    ...
    status: Mapped[SellOfferStatus] = mapped_column(
        String(32), nullable=False, default=SellOfferStatus.ACTIVE, index=True
    )
